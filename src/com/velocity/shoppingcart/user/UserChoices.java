...
import com.velocity.shoppingcart.homscreen.WelcomePage;
...
//providing diffrent options to the user
public class UserChoices {
	WelcomePage wp = new WelcomePage();
	//for looping purpose
	public void userchoice2() throws Exception {
		userChoice();
	}
	
	//here we are providing diffrent options to the user
